...
## 适用范围
本规程适用于合同审批例会相关事项，由项目管理办公室负责制度解释、流程维护和执行监督。
适用于金额约 13000 元以上、需要跨部门留痕或形成项目档案的业务事项。
所有申请、审批、用印、付款、会议结论和项目报告均应在对应系统中形成可追溯记录。

## 会议基本信息
合同审批例会由项目经理主持，项目管理办公室、业务负责人、财务或法务根据议题参加。
会议目标是同步事项进展、确认风险状态、形成行动项，并为后续周报或审批材料提供依据。
本次会议涉及金额口径约 13000 元，若后续进入采购或合同流程，需要补充审批编号。
...
## 操作记录样例
样例编号为 MEETING-0068，申请部门为客户成功组，责任部门为项目管理办公室，事项主题为合同审批例会。
