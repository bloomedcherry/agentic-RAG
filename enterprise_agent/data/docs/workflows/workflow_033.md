...
## 适用范围
本规程适用于会议纪要生成项目周报相关事项，由项目管理办公室负责制度解释、流程维护和执行监督。
适用于金额约 14000 元以上、需要跨部门留痕或形成项目档案的业务事项。
所有申请、审批、用印、付款、会议结论和项目报告均应在对应系统中形成可追溯记录。

## 流程入口
会议纪要生成项目周报流程由申请人在业务系统发起，入口字段包括事项名称、金额、预算编号、合同编号、供应商或项目名称。
当金额达到 14000 元、涉及合同审批或影响项目预算时，系统应要求申请人补充业务背景和预期交付结果。
流程发起前，申请人应确认需求已通过部门内部讨论，避免审批链路中反复修改需求范围。

## 节点与角色
第一节点由直属负责人确认业务必要性，重点看申请事项是否与部门目标、客户承诺或项目计划一致。
第二节点由项目管理办公室复核预算、制度口径和归档字段，必要时要求补充询价、合同或会议纪要。
...
## 超时处理
任一节点超过 1 个工作日未处理时，系统提醒当前审批人；超过两个提醒周期后升级到部门负责人。
...
## 操作记录样例
样例编号为 WORKFLOW-0033，申请部门为客户成功组，责任部门为项目管理办公室，事项主题为会议纪要生成项目周报。
申请人提交的业务说明应包含事项背景、预计金额 14000 元、期望完成时间、关联项目和外部相对方。
