...
## 操作记录样例
样例编号为 WORKFLOW-0003，申请部门为客户成功组，责任部门为项目管理办公室，事项主题为会议纪要生成项目周报。
申请人提交的业务说明应包含事项背景、预计金额 8000 元、期望完成时间、关联项目和外部相对方。
