...
适用于金额约 13000 元以上、需要跨部门留痕或形成项目档案的业务事项。
所有申请、审批、用印、付款、会议结论和项目报告均应在对应系统中形成可追溯记录。

## 流程入口
合同审批流程由申请人在业务系统发起，入口字段包括事项名称、金额、预算编号、合同编号、供应商或项目名称。
当金额达到 13000 元、涉及合同审批或影响项目预算时，系统应要求申请人补充业务背景和预期交付结果。
...
## 操作记录样例
样例编号为 WORKFLOW-0008，申请部门为客户成功组，责任部门为项目管理办公室，事项主题为合同审批。
申请人提交的业务说明应包含事项背景、预计金额 13000 元、期望完成时间、关联项目和外部相对方。
