...
## 适用范围
本规程适用于差旅费用分析相关事项，由项目管理办公室负责制度解释、流程维护和执行监督。
适用于金额约 16000 元以上、需要跨部门留痕或形成项目档案的业务事项。
所有申请、审批、用印、付款、会议结论和项目报告均应在对应系统中形成可追溯记录。

## 报告摘要
差旅费用分析为专项报告，由项目管理办公室整理，覆盖进展、风险、预算、审批和后续计划。
本期关注金额约 80000 元，重点核对采购、合同、差旅和项目成本是否与台账一致。
...
## 操作记录样例
样例编号为 REPORT-0023，申请部门为客户成功组，责任部门为项目管理办公室，事项主题为差旅费用分析。
