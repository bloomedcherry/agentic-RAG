...
## 适用范围
本规程适用于B 项目相关事项，由项目管理办公室负责制度解释、流程维护和执行监督。
适用于金额约 13000 元以上、需要跨部门留痕或形成项目档案的业务事项。
所有申请、审批、用印、付款、会议结论和项目报告均应在对应系统中形成可追溯记录。

## 项目背景
B 项目由项目管理办公室牵头，目标是在既定预算内完成业务流程优化、系统交付和跨部门协同。
当前预算基准约为 130000 元，核心约束包括供应商交付、关键接口、业务验收和合同付款节点。
...
## 操作记录样例
样例编号为 PROJECT-0068，申请部门为客户成功组，责任部门为项目管理办公室，事项主题为B 项目。
